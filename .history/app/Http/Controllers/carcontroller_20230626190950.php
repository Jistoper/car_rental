...
class CarController extends Controller
{
    ...
    public function getListMtn()
    {
        ...
        return view('backsite.content.maintenance.mtntable', ['Mtn' => $mtn['MaintenanceHistory']]);
    }

    public function createMtn()
    {
        return view('backsite.content.maintenance.createmtn');
    }
