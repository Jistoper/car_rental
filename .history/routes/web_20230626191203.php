...
Route::controller(CarController::class)->as('car.')->group(function(){
    ...
    Route::get('/maintenance_add', 'createMtn')->name('createMtn'); // maintenance create (view form)
    Route::get('/maintenance_edit', 'mtnEditView')->name('mtnEdit'); // maintenance edit (view form)
