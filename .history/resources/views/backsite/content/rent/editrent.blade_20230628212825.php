...
<div>
    <div class="pagetitle row mb-3">
        <div class="col-md-1">
        <a type="button" href="{{ route('car.rentStoreEdit') }}" class="btn btn-outline-danger rounded-pill bi-chevron-left"> Back</a>
        </div>
        <h3 class="col-md-4">Edit Rent Data</h3>
    </div>
    <form action="{{ route('car.rentStoreEdit', $data['car_id']) }}" method="POST" class="row g-3">
        @csrf
