...
<div>
    ...
    <form action="{{ route('car.storeRent', $data['car_id']) }}" method="POST" class="row g-3">
        ...
        <div class="col-md-3">
            <div class="form-floating">
                <input type="date" name="rent_date" id="rent_date" class="form-control" placeholder="Rent Date" disabled>
                <label for="rent_date">Rent Date</label>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-floating">
                <input type="date" name="return_date" id="return_date" class="form-control" placeholder="Return Date" disabled>
