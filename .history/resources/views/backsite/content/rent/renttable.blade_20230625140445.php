        ...
        <tbody>
            @foreach($Cars as $cars)
                <tr>
                    ...
                    <td>
                        <form action="{{ route('car.rentView', $cars['car_id']) }}" class="d-inline" method="POST">
                            @csrf
                            @method('GET')
                            ...
                            <button class="btn btn-sm rounded-pill btn-outline-secondary" type="submit" name='submit'>Rent</button>
                        </form>
                    </td>
                </tr>
            @endforeach
