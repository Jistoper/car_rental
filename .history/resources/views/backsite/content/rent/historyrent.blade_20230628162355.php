        ...
        <tbody>
            @foreach($Rent as $index => $rent)
                <tr>
                    ...
                    <td>
                        <button name="submit" type="button" class="btn btn-sm btn-outline-info rounded-pill bi-eye" data-bs-toggle="modal" data-bs-target="#basicModal{{ $mtn['rental_id'] }}">
                        </button>
                        <div class="modal fade" id="basicModal{{ $mtn['rental_id'] }}" tabindex="-1">
