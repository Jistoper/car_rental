        ...
        <tbody>
            @foreach($Rent as $index => $rent)
                <tr>
                    ...
                    <td>
                        <button name="submit" type="button" class="btn btn-sm btn-outline-success rounded-pill bi-check" data-bs-toggle="modal" data-bs-target="#basicModal{{ $rent['rental_id'] }}">
                        </button>
