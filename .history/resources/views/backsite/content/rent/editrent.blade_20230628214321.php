        ...
        <div class="col-md-3">
            <div class="form-floating mb-3">
                <select class="form-select" id="usage_region" name="usage_region" aria-label="usage_region">
                    <option {{ $data['usage_region'] === 'Sukun' ? 'selected' : '' }}>Sukun</option>
                    <option {{ $data['usage_region'] === 'Lowokwaru' ? 'selected' : '' }}>Lowokwaru</option>
                    <option {{ $data['usage_region'] === 'Klojen' ? 'selected' : '' }}>Klojen</option>
                    <option {{ $data['usage_region'] === 'Kedungkandang' ? 'selected' : '' }}>Kedungkandang</option>
                    <option {{ $data['usage_region'] === 'Blimbing' ? 'selected' : '' }}>Blimbing</option>
                </select>
