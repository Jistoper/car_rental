        ...
        <tbody>
            @foreach($Mtn as $mtn)
                <tr>
                    ...
                    <td>{{ $mtn['expense'] }}</td>
                    <td>
                        <button name="submit" type="button" class="btn btn-sm rounded-pill btn-outline-primary bi-eye-fill" data-bs-toggle="modal" data-bs-target="#basicModal">
                        </button>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button name="submit" type="submit" class="btn btn-outline-danger" id="confirmDelete">Delete</button>
                                    </div>
                                </div>
                            </div>
                        </div>
