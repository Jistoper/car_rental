    ...
    <form action="{{ route('car.storeEdit') }}" method="POST" class="row g-3">
        ...
        <div class="col-md-3">
            <div class="form-floating">
                <input type="text" name="last_odometer" id="last_odometer" class="form-control @error('brand') border-red-500 @enderror" value="{{ $data['last_odometer'] }}" placeholder="Last Odometer">
