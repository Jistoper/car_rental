                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('car.mtnEdit', $mtn['maintenance_id']) }}" class="d-inline" method="POST">
                            ...
                            <button class="btn btn-sm rounded-pill btn-outline-secondary bi-pencil" type="submit" name='submit'> Edit</button>
                        </form>
                        <form onsubmit="return confirm('Are you sure you want to delete this data?')" action="{{ route('car.delete', $mtn['car_id']) }}" class="d-inline" method="POST">
                            ...
                            <button class="btn btn-sm rounded-pill btn-outline-danger bi-x-circle" type="submit" name='submit'> Delete</button>
                        </form>
                    </td>
                </tr>
            @endforeach
