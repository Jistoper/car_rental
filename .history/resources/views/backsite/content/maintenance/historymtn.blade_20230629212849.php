            ...
            @foreach($Mtn as $index => $mtn)
                <tr>
                    ...
                    <td>
                        ...
                        <form id="EditMaintenance{{ $mtn['maintenance_id'] }}" action="{{ route('car.mtnStoreEdit') }}" method="POST" class="row g-3 needs-validation modal fade" tabindex="-1" novalidate>
                        <div class="modal fade" id="EditMaintenance{{ $mtn['maintenance_id'] }}" tabindex="-1">
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <form id="{{ $mtn['maintenance_id'] }}" action="{{ route('car.mtnStoreEdit') }}" method="POST" class="row g-3 needs-validation" novalidate>
                                            @csrf
