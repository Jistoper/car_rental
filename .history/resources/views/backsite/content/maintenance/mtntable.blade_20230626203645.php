...
<div>
    <div class="pagetitle row">
        ...
        <div class="col-md-2">
            <a href="{{ route('car.createMtn') }}" class="btn btn-outline-primary rounded-pill bi-plus-lg"> Add Data</a>
        </div>
    </div>
    <div class="mb-3">
        ...
        <tbody>
            @foreach($Mtn as $index => $mtn)
                <tr>
                    ...
                    <td>{{ $mtn['expense'] }}</td>
                    <td>
                        <button name="submit" type="button" class="btn btn-sm btn-outline-info rounded-pill bi-eye-fill" data-bs-toggle="modal" data-bs-target="#basicModal{{ $mtn['maintenance_id'] }}">
                        </button>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p>
                                            ...
                                            {{ $CarData[$mtn['car_id']]['brand'] }}
                                        </p>
                                        <p>
                                            <b>
                                                Model :
                                            </b>
                                            {{ $CarData[$mtn['car_id']]['model'] }}
                                        </p>
                                        <!-- Add more car data fields here -->
                                        <p>
                                            <b>
                                                Last Odometer :
                                            </b>
