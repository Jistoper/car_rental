            ...
            @foreach($Mtn as $index => $mtn)
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-sm rounded-pill btn-outline-secondary bi-pencil" data-bs-toggle="modal" data-bs-target="#EditMaintenance"></button>
                        <div class="modal fade" id="EditMaintenance" tabindex="-1">
