...
<div>
  <div class="pagetitle row mb-3">
    ...
    <form action="{{ route('car.getListMtn') }}" method="POST" class="row g-3">
        ...
        <div class="col-md-12">
            <div class="form-floating">
                <textarea type="text" name="description" id="description" class="form-control @error('description') border-red-500 @enderror" value="{{ $data['description'] }}" placeholder="Description">
