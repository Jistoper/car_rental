                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('car.storeMtn') }}" method="POST" class="row g-3 needs-validation" novalidate>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-floating">
                                                    <input type="text" name="brand" id="brand" class="form-control" value="{{ Session::has('brand') ? Session::get('brand') : $Car[$mtn['car_id']]['registration_number'] }}" placeholder="Brand" disabled>
                                                    <label for="brand">Brand</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-floating">
                                                    <input type="text" name="model" id="model" class="form-control" value="{{ Session::has('model') ? Session::get('model') : $Car[$mtn['car_id']]['registration_number'] }}" placeholder="Model" disabled>
