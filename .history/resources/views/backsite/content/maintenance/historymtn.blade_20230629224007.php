                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('car.mtnStoreEdit') }}" method="POST" class="row g-3 needs-validation" novalidate>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-floating">
                                                    <textarea type="text" name="description" id="description" class="form-control" placeholder="Description" style="height: 150px;" value="{{ $mtn['description'] }}" required></textarea>
