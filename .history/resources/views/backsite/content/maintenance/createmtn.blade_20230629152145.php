...
<div>
    ...
    <form action="{{ route('car.storeMtn') }}" method="POST" class="row g-3">
        ...
        <div class="col-md-12">
            <div class="form-floating">
                <input type="text" name="last_odometer" id="last_odometer" class="form-control @error('last_odometer') is-invalid @enderror" value="{{ Session::get('last_odometer') }}" placeholder="Last Odometer">
