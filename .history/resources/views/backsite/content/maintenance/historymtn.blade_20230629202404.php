                                        ...
                                        <form action="{{ route('car.storeMtn') }}" method="POST" class="row g-3 needs-validation" novalidate>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-floating">
                                                    <input type="text" name="car_id" id="car_id" class="form-control" value="{{ Session::has('car_id') ? Session::get('car_id') : $mtn['car_id'] }}" placeholder="Car ID" disabled>
                                                    <label for="car_id">Car ID</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-floating">
                                                    <input type="text" name="brand" id="brand" class="form-control" value="{{ Session::has('brand') ? Session::get('brand') : $Car[$mtn['car_id']]['brand'] }}" placeholder="Brand" disabled>
                                                    <label for="brand">Brand</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-floating">
                                                    <input type="text" name="model" id="model" class="form-control" value="{{ Session::has('model') ? Session::get('model') : $Car[$mtn['car_id']]['model'] }}" placeholder="Model" disabled>
                                                    <label for="model">Model</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-floating">
                                                    <input type="text" name="registration_number" id="registration_number" class="form-control" value="{{ Session::has('registration_number') ? Session::get('registration_number') : $Car[$mtn['car_id']]['registration_number'] }}" placeholder="Registration Number" disabled>
